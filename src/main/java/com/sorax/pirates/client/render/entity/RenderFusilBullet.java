...
public class RenderFusilBullet extends Render{
    ...
    public RenderFusilBullet(RenderManager renderManager, Item item, RenderItem renderItem)
    {
        super(renderManager);
        this.item = item;
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.renderImage.renderItem(this.getItemStack(entity), ItemCameraTransforms.TransformType.GROUND);
